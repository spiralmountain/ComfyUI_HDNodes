...
from .cycling_switch import NODE_CLASS_MAPPINGS as CyclingSwitch_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as CyclingSwitch_DISPLAY
...
NODE_CLASS_MAPPINGS.update(CyclingSwitch_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(CyclingSwitch_DISPLAY)
